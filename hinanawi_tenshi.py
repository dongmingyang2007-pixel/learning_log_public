...
class HinanawiTenshi:
    def __init__(x,tht_game):
        ...
        x.rects_idle = [frame.get_rect(x = 500, y = 100) for frame in x.frames_idle]
        x.rects_walk = [frame.get_rect(x = 500, y = 100) for frame in x.frames_walk]
        x.rects_hinanawi_tenshi_dash_forward_air_A = [frame.get_rect(x = 500, y = 100) for frame in x.frames_hinanawi_tenshi_dash_forward_air_A]
        x.rects_hinanawi_tenshi_sit = [frame.get_rect(x = 500, y = 100) for frame in x.frames_hinanawi_tenshi_sit]
